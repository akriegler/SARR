...
ITODD_OBJECTS = {
    ...
    4: { # in BOP has permutation  matrices
        ...
        'sym_id': 0,
        'sym_cls': '1_1_1',
        'kappa':np.array([1,1,1]),  # actually this object has a symmetry, but its non-periodic in a way. the matrix below (after I) gives it, its (-180, 0, 90)
    ...
    14: {
        ...
        'sym_id': 5,
        'sym_cls': '1_1_2',  # originally 1-1-18
    ...
    23: {
        ...
        'sym_cls':  '1_1_INF',  # changed from 1_1_6 originally
        'kappa':np.array([1,1,10 ** 3]),
        'sym_permutations': [np.eye(3, dtype=np.float64)],
...
TLESS_OBJECTS = {
    ...
    7: {'sym_cls': 'II',
        ...
        'avg_tz': 639.473},
    8: {'sym_cls': 'II',
        'kappa': np.array([1, 1, 2]),  # approximation to T-LESS anno, i.e. they put a weird matrix
