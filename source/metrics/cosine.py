...
def main():
    eval_files_tless_other = \
        [
            ...
            'results/T-LESS/others/wang-hcceposebf_tless-test.csv',
            'results/T-LESS/others/labbe-cosypose_tless-test.csv',
    ...
    eval_files_itodd_ours = \
        [
            ...
            #'results/ITODD/ours/SARR/sarr-datasetnohm_itodd-test.csv',
            ...
            #'results/ITODD/ours/SARR/sarr-datasetnohm-rgb_itodd-test.csv',
